...
void parquet() {
    ...
    int fitCount = (int) (width / (x12+x13+x23) * 3 )+1;    
    ...
    for (int i = 0; i < fitCount; i++) {        
        ...
        drawParallelLinesCombined(x1, y1, x3, y3, x2_tmp, y2_tmp, x1_tmp, y1_tmp, x13, y13, fitCount);
